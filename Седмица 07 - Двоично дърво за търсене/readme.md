...
- bool is_balanced() const - проверява дали дървото е балансирано. Казваме, че дърво е балансирано, ако разликата във височините на лявото и дясното му поддървета е по-малка или равна на 1 като и самите поддървета трябва също да са балансирани;
