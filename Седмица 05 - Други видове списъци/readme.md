# Седмица 05 - Други видове списъци
...
Използвайки тази реализация, направете реализация на опашка с два края (deque).

## Задача 02 - Цикличен едносвързан списък
...
Към тази основна реализация добавете и следните методи:

- void reverse() - обръща реда на елементите като запазва цикличността
- void append(const CircularLinkedList& other) - "закача" два циклични списъка, така че в резултатния списък да има само един цикъл (последният елемент на втория списък трябва да сочи към първия елемент на първия списък и обратно)
- std::pair\<CircularLinkedList\<T>, CircularLinkedList\<T>> split() const - разделя списъка на 2 циклични списъка с равна дължина (или с разлика 1, ако броят елементи е нечетен)
